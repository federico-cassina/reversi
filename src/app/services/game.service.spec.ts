...
describe('GameService', () => {
  ...
  it('should process correctly 1 move', inject([GameService], (service: GameService) => {
    ...
    expect(board.cells[29]).toEqual(CellStatus.emptyValidMove);
...
/*    expect(board.cells.toEqual([
                ...
                CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove,
                CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove, CellStatus.emptyValidMove,   CellStatus.black,            CellStatus.emptyValidMove,   CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove,
                CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove, CellStatus.black,            CellStatus.black,            CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove,
                CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove, CellStatus.white,            CellStatus.black,            CellStatus.emptyValidMove,   CellStatus.emptyInvalidMove, CellStatus.emptyInvalidMove,
